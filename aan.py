...
import time, random, sys, re, os, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, urllib2, wikipedia,tempfile,glob,shutil,unicodedata,goslate,_base
from gtts import gTTS

#tinkerbell
cl = LINETCR.LINE()
#cl.login(qr=True)
cl.login(token="EpBWpcHUiJ3rmI0JGR8c.uwng+Vb056dl2AsciEgpda.6vc9fYAXxHkGzfbuEbPQolmYhuiO9P1t8fh1H9y4rMg=")
cl.loginResult()
#vidia
#kt = LINETCR.LINE()
